...
Session.prototype.enableChildGating = function () {
  return this[$].enableChildGating();
};

Session.prototype.disableChildGating = function () {
  return this[$].disableChildGating();
};
...
Session.prototype.createScriptFromBytes = function (bytes) {
  return this[$].createScriptFromBytes(bytes).then(function (impl) {
    return new Script(impl);
  });
};

Session.prototype.compileScript = function (source, options) {
  options = options || {};
  var name = options.name || null;
  return this[$].compileScript(name, source);
};
...
Session.prototype.enableJit = function () {
